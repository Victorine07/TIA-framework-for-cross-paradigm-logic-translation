...
definition sparx_128_128_block_size :: nat where "sparx_128_128_block_size = 128"


definition sparx_128_128_key_size :: nat where "sparx_128_128_key_size = 128"


definition sparx_128_128_n_steps :: nat where "sparx_128_128_n_steps = 8"


definition sparx_128_128_rounds_per_step :: nat where "sparx_128_128_rounds_per_step = 4"


definition sparx_128_128_word_size :: nat where "sparx_128_128_word_size = 16"


definition sparx_128_128_n_branches :: nat where "sparx_128_128_n_branches = 4"


definition sparx_128_128_n_words :: nat where "sparx_128_128_n_words = 8"


definition sparx_128_128_total_rounds :: nat where 
  "sparx_128_128_total_rounds = sparx_128_128_n_steps * sparx_128_128_rounds_per_step"


definition sparx_128_128_round_key_words :: nat where
  "sparx_128_128_round_key_words = 4"


definition sparx_128_128_rol :: "'a::len word \<Rightarrow> nat \<Rightarrow> 'a word" where
  "sparx_128_128_rol x r = word_rotl r x"


definition sparx_128_128_ror :: "'a::len word \<Rightarrow> nat \<Rightarrow> 'a word" where
  "sparx_128_128_ror x r = word_rotr r x"


definition sparx_128_128_A_perm_16 :: "16 word \<Rightarrow> 16 word \<Rightarrow> (16 word \<times> 16 word)" where
...
definition sparx_128_128_A_perm_16_inv :: "16 word \<Rightarrow> 16 word \<Rightarrow> (16 word \<times> 16 word)" where
...
definition sparx_128_128_L_w :: "16 word \<Rightarrow> 16 word" where
  "sparx_128_128_L_w x = xor (push_bit 8 x) (drop_bit 8 x)"


definition sparx_128_128_linear_layer :: "16 word list \<Rightarrow> 16 word list" where
...
definition sparx_128_128_linear_layer_inv :: "16 word list \<Rightarrow> 16 word list" where
...
definition sparx_128_128_extract_key_words :: "128 word \<Rightarrow> 16 word list" where
...
function sparx_128_128_gen_key_schedule_iterate ::
  "16 word list \<Rightarrow> nat \<Rightarrow> nat \<Rightarrow> 16 word list \<Rightarrow> 16 word list" where
"sparx_128_128_gen_key_schedule_iterate k c idx rk = (
  if idx \<ge> sparx_128_128_total_rounds then rk
  else
    let
      rk_new = rk @ [k!0, k!1, k!2, k!3];
      (k0', k1') = sparx_128_128_A_perm_16 (k!0) (k!1);
      k2' = k!2 + k0';
      ...
      k_next =
        [k0', k1', k2', k3',
         k!4, k!5, k!6, k!7]
    in
      sparx_128_128_gen_key_schedule_iterate
        k_next (c + 1) (idx + 1) rk_new
)"
by pat_completeness auto
termination
  apply (relation "measure (\<lambda>(k,c,idx,rk). sparx_128_128_total_rounds - idx)")
  apply auto
  done


definition sparx_128_128_generate_key_schedule :: "128 word \<Rightarrow> 16 word list" where
  "sparx_128_128_generate_key_schedule master_key = (
    ...
    in sparx_128_128_gen_key_schedule_iterate initial_k 1 0 [])"


function sparx_128_128_get_round_key_iterate ::
  "16 word list \<Rightarrow> nat \<Rightarrow> nat \<Rightarrow> 16 word list \<Rightarrow> 16 word list" where
...
definition sparx_128_128_get_all_round_keys :: "16 word list \<Rightarrow> 16 word list" where
...
definition sparx_128_128_whitening_index :: nat where
  "sparx_128_128_whitening_index =
     (sparx_128_128_total_rounds - 1) * sparx_128_128_round_key_words"


definition sparx_128_128_apply_encrypt_round ::
...
definition sparx_128_128_apply_decrypt_round ::
  "16 word list \<Rightarrow> 16 word list \<Rightarrow> 16 word list" where
...
function sparx_128_128_encrypt_step_iterate :: 
...
function sparx_128_128_decrypt_step_iterate :: 
  "16 word list \<Rightarrow> 16 word list \<Rightarrow> nat \<Rightarrow> nat \<Rightarrow> 16 word list" where
...
definition sparx_128_128_block_to_words :: "128 word \<Rightarrow> 16 word list" where
...
definition sparx_128_128_words_to_block :: "16 word list \<Rightarrow> 128 word" where
...
function sparx_128_128_decrypt_steps_iterate ::
...
function sparx_128_128_encrypt_steps_iterate :: 
  "16 word list \<Rightarrow> 16 word list \<Rightarrow> nat \<Rightarrow> 16 word list" where
...
definition sparx_128_128_encrypt_block ::
...
definition sparx_128_128_decrypt_block ::
  "128 word \<Rightarrow> 16 word list \<Rightarrow> 128 word" where
...
definition sparx_128_128_encrypt :: "128 word \<Rightarrow> 128 word \<Rightarrow> 128 word" where
  "sparx_128_128_encrypt plaintext master_key = (
    let rk_words = sparx_128_128_generate_key_schedule master_key
    in sparx_128_128_encrypt_block plaintext rk_words)"


definition sparx_128_128_decrypt :: "128 word \<Rightarrow> 128 word \<Rightarrow> 128 word" where
  "sparx_128_128_decrypt ciphertext master_key = (
    let rk_words = sparx_128_128_generate_key_schedule master_key
    in sparx_128_128_decrypt_block ciphertext rk_words)"


definition sparx_128_128_test_key :: "128 word" where
  "sparx_128_128_test_key = 0x0123456789ABCDEF0123456789ABCDEF"


definition sparx_128_128_test_plaintext :: "64 word" where
  "sparx_128_128_test_plaintext = 0xDEADBEEFCAFEBABE"
